...
const ApplePieDay = () => {
  return (
    <div id='apple-pie-day' className='apple-pie-day'>
      <div className='apple-pie-day__container container'>
        <h2 className='white'>Apple Pie Day</h2>
        <h3 className='white'>
