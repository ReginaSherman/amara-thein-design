...
const SchoolSupplyDrive = () => {
  return (
    <div id='school-supply-drive' className='school-supply-drive'>
      <div className='school-supply-drive__container container'>
        <h2 className='white'>School Supply Drive</h2>
        <h3 className='white'>
...
export default SchoolSupplyDrive
